/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: e51f0e2ac2b9171e2c76fd5b8d2885eb)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    NEXT_PUBLIC_MOCK_CHECKOUT: string;
    NEXT_PUBLIC_E2E_TEST_SECRET: string;
    NODE_ENV: string;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | "NEXT_PUBLIC_MOCK_CHECKOUT"
      | "NEXT_PUBLIC_E2E_TEST_SECRET"
      | "NODE_ENV"
    >
  > {}
}
