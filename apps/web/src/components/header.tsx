...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 border-b border-border/50 bg-charcoal/80 backdrop-blur-xl">
      <nav className="max-w-7xl mx-auto flex items-center justify-between gap-4 px-6 h-16">
        ...
        <div className="flex items-center gap-6">
          ...
          >
            ...
            <span className="font-display font-bold text-cream group-hover:text-gold transition-colors tracking-tight">
              TanStack Start
            </span>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-1">
            <Link
              to="/"
              className="px-3 py-1.5 rounded-lg text-sm font-medium text-cream/70 hover:text-cream hover:bg-white/5 transition-all"
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden xl:flex items-center gap-1 border-r border-border/30 pr-2 mr-1">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="p-2 text-cream/40 hover:text-cream hover:bg-white/5 rounded-lg transition-all"
            >
          ...
          <details className="relative lg:hidden">
            <summary className="list-none cursor-pointer p-2 text-cream/70 hover:text-cream hover:bg-white/5 rounded-lg transition-all">
              <svg
                viewBox="0 0 24 24"
                width="20"
                height="20"
            ...
            <div className="absolute top-full right-0 mt-2 w-48 py-2 bg-charcoal-light border border-border shadow-2xl rounded-xl">
              <Link
                to="/demo/ai-chat"
                className="block px-4 py-2 text-sm text-cream/70 hover:text-gold hover:bg-white/5"
              >
                AI Chat
              </Link>
              <Link
