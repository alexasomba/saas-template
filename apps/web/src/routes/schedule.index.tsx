                  ...
                  >
                    <div className="relative flex gap-6 md:gap-10">
                      ...
                      <div className="shrink-0 w-16 md:w-24 pt-6">
                        <div className="relative">
                          {/* Timeline dot */}
                          <div className="absolute -right-3.25 md:-right-4.25 top-0 w-6 h-6 rounded-full bg-charcoal border-2 border-gold flex items-center justify-center group-hover:border-copper group-hover:scale-110 transition-all">
                        ...
                        <div className="relative p-6 md:p-8 flex flex-col md:flex-row gap-6 items-start">
                          ...
                          <div className="shrink-0 self-center">
                            <div className="w-10 h-10 rounded-full bg-gold/10 border border-gold/20 flex items-center justify-center group-hover:bg-gold/20 group-hover:border-gold/40 transition-all">
                              <CaretRight className="w-5 h-5 text-gold group-hover:translate-x-0.5 transition-transform" />
                            </div>
                          </div>
                        </div>
                      </div>
